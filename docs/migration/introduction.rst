...
.. |SAMEHOSTMIGRATIONFUTUREQUALIFICATION| replace:: preferable if a same-host migration is needed, and there is sufficient storage space to hold a LOCKSS 1.x copy and a LOCKSS 2.x copy of the content simultaneously
...
.. |SAMEHOSTMIGRATIONINCREMENTALQUALIFICATION| replace:: available only if a same-host migration is needed, but there is insufficient storage space to hold a LOCKSS 1.x copy and a LOCKSS 2.x copy of the content simultaneously

You must select one of two migration scenarios:
...
This :ref:`Migration Scenario` is available |SAMEHOSTMIGRATIONQUALIFICATION|. It has two subtypes:
...
This :ref:`Migration Scenario` is |SAMEHOSTMIGRATIONFUTUREQUALIFICATION|.
...
This :ref:`Migration Scenario` is |SAMEHOSTMIGRATIONINCREMENTALQUALIFICATION|.
